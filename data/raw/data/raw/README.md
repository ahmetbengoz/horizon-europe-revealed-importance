...
The raw project data used in this study are obtained from the official
CORDIS Horizon Europe open dataset provided by the European Commission.
...
from the source URL and placing it in this folder with the filename:
